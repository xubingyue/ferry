...
int lua_ferry_Service_setConnectTimeout(lua_State* tolua_S)
{
    int argc = 0;
    ferry::Service* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_ferry_Service_setConnectTimeout'", nullptr);
        return 0;
    }
#endif
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_ferry_Service_setConnectTimeout'.",&tolua_err);
#endif
...
int lua_register_ferry_Service(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"Service");
        ...
        tolua_function(tolua_S,"setConnectTimeout",lua_ferry_Service_setConnectTimeout);
...
int lua_ferry_Ferry_isConnected(lua_State* tolua_S)
{
    int argc = 0;
    ferry::Ferry* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_ferry_Ferry_isConnected'", nullptr);
        return 0;
    }
#endif
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_ferry_Ferry_isConnected'.",&tolua_err);
#endif
...
int lua_ferry_Ferry_setConnectTimeout(lua_State* tolua_S)
{
    int argc = 0;
    ferry::Ferry* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_ferry_Ferry_setConnectTimeout'", nullptr);
        return 0;
    }
#endif
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_ferry_Ferry_setConnectTimeout'.",&tolua_err);
#endif
...
int lua_ferry_Ferry_isRunning(lua_State* tolua_S)
{
    int argc = 0;
    ferry::Ferry* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_ferry_Ferry_isRunning'", nullptr);
        return 0;
    }
#endif
...
int lua_register_ferry_Ferry(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"Ferry");
        ...
        tolua_function(tolua_S,"setConnectTimeout",lua_ferry_Ferry_setConnectTimeout);
